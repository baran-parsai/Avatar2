...
if __name__ == "__main__":
    ...
    parser.add_argument('--destination', type=str, default='/home/baranparsai/Documents/Avatar2', help='Directory where to save the pkl and json files.')

    args = parser.parse_args()

    data_location = args.source
    json_location = args.destination + '/people/faces.json'  
    output_location = args.destination + '/people/faces.pkl'  
